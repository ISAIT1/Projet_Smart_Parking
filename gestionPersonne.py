...
class users:
    def __init__(self, window):
        ...
        # -----------------------------------
        # ---------icon de la fenetre------
        icon = PhotoImage(file='imagesIc\\icon_parking.png')
        ...
        # -----------------------------------
        # ---------Sidebar------------------
        self.sidebar = Frame(self.window, bg='#e6f0ff')
        ...
        self.date_time_image = Label(self.sidebar, image=photo, bg='#e6f0ff')
        ...
        self.date_time.configure(text=self.set_text, font=("", 13, "bold"), bd=0, bg='#e6f0ff', fg="#00294B")
        ...
        # -----Formulaire--------
        # Label
        Label(text="Nom", font=("", 13, "bold"), fg="#0D294B").place(x=15, y=250)
        Label(text="Prénom", font=("", 13, "bold"), fg="#0D294B").place(x=15, y=280)
        Label(text="Email", font=("", 13, "bold"), fg="#0D294B").place(x=15, y=310)
        Label(text="Matricule", font=("", 13, "bold"), fg="#0D294B").place(x=15, y=340)
        Label(text="Fonction", font=("", 13, "bold"), fg="#0D294B").place(x=15, y=370)

        # Entry
        self.nom_entry = Entry(self.sidebar, textvariable=self.id_var, font=("", 13, "bold"), fg="#0D294B", width=20)
        self.nom_entry.place(x=100, y=200)
        self.nom_entry = Entry(self.sidebar, textvariable=self.nom_var, font=("", 13, "bold"), fg="#0D294B", width=20)
        self.nom_entry.place(x=100, y=250)
        self.prenom_entry = Entry(self.sidebar, textvariable=self.prenom_var, font=("", 13, "bold"), fg="#0D294B",
                                  width=20)
        self.prenom_entry.place(x=100, y=280)
        self.email_entry = Entry(self.sidebar, textvariable=self.email_var, font=("", 13, "bold"), fg="#0D294B",
                                 width=20)
        self.email_entry.place(x=100, y=310)
        self.matricule_entry = Entry(self.sidebar, textvariable=self.matricule_var, font=("", 13, "bold"), fg="#0D294B",
                                     width=20)
        self.matricule_entry.place(x=100, y=340)
        # combobox
        ...
        self.heading = Label(self.window, text='Gestion des personnes', font=("", 13, "bold"), fg='#0D294B',
                             bg='#eff5f6')
